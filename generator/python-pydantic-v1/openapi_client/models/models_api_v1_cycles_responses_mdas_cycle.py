...
class ModelsApiV1CyclesResponsesMDASCycle(BaseModel):
    """
    ...
    __properties = ["cycle_id", "scaled_strain", "during", "predicted_end", "timezone_offset", "days", "data_state", "day_strain", "day_kilojoules", "day_avg_heart_rate", "day_max_heart_rate", "user_id", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModelsApiV1CyclesResponsesMDASCycle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModelsApiV1CyclesResponsesMDASCycle:
        """Create an instance of ModelsApiV1CyclesResponsesMDASCycle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModelsApiV1CyclesResponsesMDASCycle.parse_obj(obj)

        _obj = ModelsApiV1CyclesResponsesMDASCycle.parse_obj({
