...
class UpdateMDASRecoveryRequestV2(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateMDASRecoveryRequestV2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateMDASRecoveryRequestV2:
        """Create an instance of UpdateMDASRecoveryRequestV2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateMDASRecoveryRequestV2.parse_obj(obj)

        _obj = UpdateMDASRecoveryRequestV2.parse_obj({
