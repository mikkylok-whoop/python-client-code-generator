...
class ModelsApiV2ActivitiesRequestsCreateMDASActivityRequest(BaseModel):
    """
    ...
    __properties = ["user_id", "start_timestamp", "end_timestamp", "timezone", "timezone_offset", "source", "score_state", "type", "score_type", "source_id", "version", "cycle_id", "created_at", "updated_at", "activity_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModelsApiV2ActivitiesRequestsCreateMDASActivityRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModelsApiV2ActivitiesRequestsCreateMDASActivityRequest:
        """Create an instance of ModelsApiV2ActivitiesRequestsCreateMDASActivityRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModelsApiV2ActivitiesRequestsCreateMDASActivityRequest.parse_obj(obj)

        _obj = ModelsApiV2ActivitiesRequestsCreateMDASActivityRequest.parse_obj({
