...
class ModelsApiV1ActivitiesRequestsCreateMDASActivityRequest(BaseModel):
    """
    ...
    __properties = ["activity_v1_id", "version", "cycle_id", "score_type", "user_id", "created_at", "updated_at", "timezone", "timezone_offset", "activity_source", "score_state", "activity_type", "source_id", "gps_enabled", "during", "activity_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModelsApiV1ActivitiesRequestsCreateMDASActivityRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModelsApiV1ActivitiesRequestsCreateMDASActivityRequest:
        """Create an instance of ModelsApiV1ActivitiesRequestsCreateMDASActivityRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModelsApiV1ActivitiesRequestsCreateMDASActivityRequest.parse_obj(obj)

        _obj = ModelsApiV1ActivitiesRequestsCreateMDASActivityRequest.parse_obj({
