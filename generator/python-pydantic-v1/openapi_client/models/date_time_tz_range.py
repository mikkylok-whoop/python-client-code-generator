...
class DateTimeTzRange(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DateTimeTzRange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DateTimeTzRange:
        """Create an instance of DateTimeTzRange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DateTimeTzRange.parse_obj(obj)

        _obj = DateTimeTzRange.parse_obj({
            "lower": obj.get("lower"),
            "upper": obj.get("upper"),
