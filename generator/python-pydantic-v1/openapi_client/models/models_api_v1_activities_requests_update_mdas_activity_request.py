...
class ModelsApiV1ActivitiesRequestsUpdateMDASActivityRequest(BaseModel):
    """
    ...
    __properties = ["activity_v1_id", "version", "cycle_id", "score_type", "user_id", "created_at", "updated_at", "timezone", "timezone_offset", "activity_source", "score_state", "activity_type", "source_id", "gps_enabled", "during"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModelsApiV1ActivitiesRequestsUpdateMDASActivityRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModelsApiV1ActivitiesRequestsUpdateMDASActivityRequest:
        """Create an instance of ModelsApiV1ActivitiesRequestsUpdateMDASActivityRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModelsApiV1ActivitiesRequestsUpdateMDASActivityRequest.parse_obj(obj)

        _obj = ModelsApiV1ActivitiesRequestsUpdateMDASActivityRequest.parse_obj({
