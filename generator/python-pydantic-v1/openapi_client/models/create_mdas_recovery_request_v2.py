...
class CreateMDASRecoveryRequestV2(BaseModel):
    """
    ...
    __properties = ["user_id", "version", "cycle_id", "type", "start_timestamp", "end_timestamp", "score", "is_normal", "quality_duration", "latency", "is_significant", "debt_pre", "debt_post", "need_from_strain", "sleep_need", "habitual_sleep_need", "disturbances", "time_in_bed", "light_sleep_duration", "slow_wave_sleep_duration", "rem_sleep_duration", "cycles_count", "wake_duration", "arousal_time", "no_data_duration", "in_sleep_efficiency", "credit_from_naps", "respiratory_rate", "algo_version", "projected_score", "projected_sleep", "sleep_consistency", "skin_temp_celsius", "spo2", "total_wake_events", "optimal_sleep_time_start", "optimal_sleep_time_end", "recovery_score", "resting_heart_rate", "hrv_rmssd", "history_size", "is_calibrating", "rhr_component", "hrv_component", "recovery_rate", "hr_baseline", "score_state", "created_at", "updated_at", "recovery_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateMDASRecoveryRequestV2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateMDASRecoveryRequestV2:
        """Create an instance of CreateMDASRecoveryRequestV2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateMDASRecoveryRequestV2.parse_obj(obj)

        _obj = CreateMDASRecoveryRequestV2.parse_obj({
