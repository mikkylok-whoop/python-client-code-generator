...
class ModelsApiV1CyclesRequestsCreateMDASCycleRequest(BaseModel):
    """
    ...
    __properties = ["scaled_strain", "during", "predicted_end", "timezone_offset", "days", "data_state", "day_strain", "day_kilojoules", "day_avg_heart_rate", "day_max_heart_rate", "user_id", "created_at", "updated_at", "cycle_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModelsApiV1CyclesRequestsCreateMDASCycleRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModelsApiV1CyclesRequestsCreateMDASCycleRequest:
        """Create an instance of ModelsApiV1CyclesRequestsCreateMDASCycleRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModelsApiV1CyclesRequestsCreateMDASCycleRequest.parse_obj(obj)

        _obj = ModelsApiV1CyclesRequestsCreateMDASCycleRequest.parse_obj({
