...
class BatchCreateMDASCyclesRequest(BaseModel):
    """
    ...
    """
    cycles: conlist(ModelsApiV1CyclesRequestsCreateMDASCycleRequest) = Field(...)
    __properties = ["cycles"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BatchCreateMDASCyclesRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BatchCreateMDASCyclesRequest:
        """Create an instance of BatchCreateMDASCyclesRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BatchCreateMDASCyclesRequest.parse_obj(obj)

        _obj = BatchCreateMDASCyclesRequest.parse_obj({
            "cycles": [ModelsApiV1CyclesRequestsCreateMDASCycleRequest.from_dict(_item) for _item in obj.get("cycles")] if obj.get("cycles") is not None else None
        })
        return _obj
