...
class CreateMDASRecoveryRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateMDASRecoveryRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateMDASRecoveryRequest:
        """Create an instance of CreateMDASRecoveryRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateMDASRecoveryRequest.parse_obj(obj)

        _obj = CreateMDASRecoveryRequest.parse_obj({
