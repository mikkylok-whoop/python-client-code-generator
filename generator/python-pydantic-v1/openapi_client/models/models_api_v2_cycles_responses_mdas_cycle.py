...
class ModelsApiV2CyclesResponsesMDASCycle(BaseModel):
    """
    ...
    __properties = ["cycle_id", "user_id", "start_timestamp", "end_timestamp", "sleep_need", "predicted_end", "timezone_offset", "start_day", "end_day", "intensity_score", "data_state", "day_strain", "day_kilojoules", "day_avg_heart_rate", "day_max_heart_rate", "scaled_strain", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModelsApiV2CyclesResponsesMDASCycle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModelsApiV2CyclesResponsesMDASCycle:
        """Create an instance of ModelsApiV2CyclesResponsesMDASCycle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModelsApiV2CyclesResponsesMDASCycle.parse_obj(obj)

        _obj = ModelsApiV2CyclesResponsesMDASCycle.parse_obj({
