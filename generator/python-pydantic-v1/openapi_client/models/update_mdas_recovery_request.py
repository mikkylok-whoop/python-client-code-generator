...
class UpdateMDASRecoveryRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateMDASRecoveryRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateMDASRecoveryRequest:
        """Create an instance of UpdateMDASRecoveryRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateMDASRecoveryRequest.parse_obj(obj)

        _obj = UpdateMDASRecoveryRequest.parse_obj({
