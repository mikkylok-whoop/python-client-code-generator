...
from openapi_client.models.models_api_v1_recoveries_responses_mdas_recovery import ModelsApiV1RecoveriesResponsesMDASRecovery  # noqa: E501

class TestModelsApiV1RecoveriesResponsesMDASRecovery(unittest.TestCase):
    """ModelsApiV1RecoveriesResponsesMDASRecovery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelsApiV1RecoveriesResponsesMDASRecovery:
        """Test ModelsApiV1RecoveriesResponsesMDASRecovery
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelsApiV1RecoveriesResponsesMDASRecovery`
        """
        model = ModelsApiV1RecoveriesResponsesMDASRecovery()  # noqa: E501
        if include_optional:
            return ModelsApiV1RecoveriesResponsesMDASRecovery(
                recovery_id = 56,
                quality_duration = 56,
                sleep_score = 56,
                is_nap = True,
    ...
    def testModelsApiV1RecoveriesResponsesMDASRecovery(self):
        """Test ModelsApiV1RecoveriesResponsesMDASRecovery"""
