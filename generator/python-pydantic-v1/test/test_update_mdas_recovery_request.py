...
from openapi_client.models.update_mdas_recovery_request import UpdateMDASRecoveryRequest  # noqa: E501

class TestUpdateMDASRecoveryRequest(unittest.TestCase):
    """UpdateMDASRecoveryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMDASRecoveryRequest:
        """Test UpdateMDASRecoveryRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateMDASRecoveryRequest`
        """
        model = UpdateMDASRecoveryRequest()  # noqa: E501
        if include_optional:
            return UpdateMDASRecoveryRequest(
                quality_duration = 56,
                sleep_score = 56,
                is_nap = True,
    ...
    def testUpdateMDASRecoveryRequest(self):
        """Test UpdateMDASRecoveryRequest"""
