...
from openapi_client.models.batch_create_mdas_recoveries_request import BatchCreateMDASRecoveriesRequest  # noqa: E501

class TestBatchCreateMDASRecoveriesRequest(unittest.TestCase):
    """BatchCreateMDASRecoveriesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchCreateMDASRecoveriesRequest:
        """Test BatchCreateMDASRecoveriesRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchCreateMDASRecoveriesRequest`
        """
        model = BatchCreateMDASRecoveriesRequest()  # noqa: E501
        if include_optional:
            return BatchCreateMDASRecoveriesRequest(
                recoveries = [
                    openapi_client.models.create_mdas_recovery_request.CreateMDASRecoveryRequest(
                        quality_duration = 56, 
                        sleep_score = 56, 
                        is_nap = True, 
    ...
    def testBatchCreateMDASRecoveriesRequest(self):
        """Test BatchCreateMDASRecoveriesRequest"""
